        ...
        if (xmlFile.isFileOpen()) {
            ...
            try {
                ...
                try (BufferedReader reader = Files.newBufferedReader(path)) {
                    ...
                    this.xmlFile = new XmlFile(xmlDataExtractor.getRootElement(), fileName, filePath, sb.toString(),true, xmlDataExtractor.getAllElements(), xmlDataExtractor.getIdValidator());
                }
            } catch (IOException e) {
